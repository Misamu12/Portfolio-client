...
function SceneContent() {
  return (
    <>
      ...
      <FloatingCube position={[-3, 1.5, -2]} color="#2563EB" speed={0.8} />
      <FloatingCube position={[3.5, -1, -1.5]} color="#7C3AED" speed={1.2} />
      <FloatingCube position={[-2, -1.5, 1]} color="#06B6D4" speed={0.6} />
      <FloatingCube position={[1, 2, -3]} color="#2563EB" speed={1} />
      <FloatingCube position={[-4, 0, -2]} color="#7C3AED" speed={0.9} />
    </>
  )
}
