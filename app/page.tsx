        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ color: '#a0a8b8', lineHeight: 1.6, marginBottom: '2rem' }}>
                La plateforme moderne pour les équipes qui déploient vite. Construisez, déployez et évoluez en toute simplicité.
              </p>
              <div style={{ display: 'flex', gap: '1rem' }}>
                {['𝕏', '💼', '📘', '📷'].map((icon, i) => (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = 'rgba(107, 140, 255, 0.2)';
            ...
            <div>
              <h4 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: '1.5rem', color: '#fff' }}>
                Liens rapides
              </h4>
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {['À propos', 'Blog', 'Carrières', 'Presse', 'Partenaires'].map((item, i) => (
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {['Centre d\'aide', 'Documentation', 'FAQ', 'Statut', 'Contact'].map((item, i) => (
                  <li key={i} style={{ marginBottom: '0.8rem' }}>
                    <a
                      href="#"
                      style={{
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 10px 20px -5px rgba(107, 140, 255, 0.4)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'scale(1)';
          ...
          >
            © 2025 APEX. Tous droits réservés. | Mentions légales | Politique de confidentialité
          </div>
        </footer>
